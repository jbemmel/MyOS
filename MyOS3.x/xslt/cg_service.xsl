...
<!--
   Will generate service C++ glue code for MyOS3.x
...
: IService( container, VERSION(<xsl:value-of select="version/@major"/>,<xsl:value-of select="version/@minor"/>), ID(), (IService*&amp;) instance )
{
}

...
namespace MyOS { namespace MM { namespace Paging {

using namespace InterruptHandling;
using Paging::DemandPagedEntity;

//const uuid_t IDemandPaging::ID = "c5f5093d-07d2-4b5e-8b01-e77406bfa43e";
...
bool 
IDemandPagingImpl::init( Context::IContext& context, NVPAIR params[] ) /* INITSECTION */
{
...
void 
IDemandPagingImpl::deinit( Context::IContext& context )
{
...
{
#ifdef DEBUG 
   register u32 eip = ((u32*) Processor::ESP())[29];   // minus stackframe (0x18)
#else	// 26 ?

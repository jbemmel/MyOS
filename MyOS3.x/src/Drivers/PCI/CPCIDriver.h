...
{
protected:
   inline CPCIDriver( IContainer& container, VERSION v, const char* const id, IComponent*& instance ) 
      throw() : CDriverBase(container,v,id,instance) {}
...
public:
   ...
   inline IPCISupport& getPCISupport() const {
       return iDriverManager->getPCISupport();       
   }

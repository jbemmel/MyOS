...
template<> inline void* TreapNode<FS::ISO9660::ISO9660FileNode>::operator new( size_t )
{
   return MyOS::FS::ISO9660::allocateNoThrow( sizeof(TreapNode<FS::ISO9660::ISO9660FileNode>) );
}

template<> inline void TreapNode<FS::ISO9660::ISO9660FileNode>::operator delete( void* m )
{
...
namespace FS { namespace ISO9660 {

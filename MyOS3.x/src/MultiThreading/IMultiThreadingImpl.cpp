...
//const uuid_t IMultiThreading::ID = "3db93a90-a7c1-41df-9029-4e3895f9fab2";
...
// virtual 
Thread& 
IMultiThreadingImpl::createThread( IRunnable& runnable, NVPAIR params[], size_t paramCount, 
        MM::EDPL rpl, u32 allocOrder, bool start ) 
    throw(MM::OutOfMemoryException)
{
   return * new Thread( runnable, params, paramCount, rpl, allocOrder, start ); 
}

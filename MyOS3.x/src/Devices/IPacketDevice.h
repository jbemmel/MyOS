...
public:
     ...
     */
    virtual Packet& allocatePacket( size_t bytes ) throw (MM::OutOfMemoryException) = 0;
...
protected:
	...
	inline IPacketDevice( Core::IComponent& c, VERSION v, const char* const u, const char* const n, u32 _mtu=0 ) 

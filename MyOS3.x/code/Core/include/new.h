...
// the new[] and delete[] operator can only be overridden by *classes*
   ...
   TODO: For the 4 scopes, define dedicated namespaces to get syntax like:
    ::new Object                // global allocation
    CurrentProcess::new Object  // current process
    CurrentThread::new Object   // current thread (can also do specific thread object)
    XXComponent::new            // specific component
...
// function prototype
EXPORT void operator delete( void*, size_t );

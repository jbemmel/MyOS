 ...
 ***************************************************************************/
// #include "../build/gen_src/myosconfig.h" // CONFIG_IDisplay
...
ScreenBuffer::ScreenBuffer( void* screenbase ) throw()
...
ScreenBuffer::Cursor::print( const char *src, size_t length, EColor att )
{
	...
	// Protect this code...
	// XX This lock should be recursive! In case of interrupts...
#ifdef LOCKING
...
ScreenBuffer::setCursor(u32 row, u32 col)
{
   ...
   volatile IOPort8<0x3D4> VGA_INDEX;
   volatile IOPort8<0x3D5> VGA_DATA;

...
#include "IInterruptHandling.h"  // E_IRQVector
...
private:
	...
	volatile IOPort8< 0x20 > MASTER_IO;
	volatile IOPort8< 0x21 > MASTER_DATA;
	volatile IOPort8< 0xa0 > SLAVE_IO;
	volatile IOPort8< 0xa1 > SLAVE_DATA;	

...
#include "Display/screentypes.h"    // EColor
#include "defs.h"                   // EXPORT
...
EXPORT void assertionFailed( E_SEVERITY s, const char* fileline, const char* func, int debugvalue );
EXPORT void checkpoint( char c, EColor color = E_WHITE );

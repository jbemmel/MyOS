 ...
 */
struct ATAPICommandPacket   // @todo alignment fails under gcc, bitfields not correct yet
{
   u8 opcode;
   u8 __res0;
   ...
   {
      ASSERTION( sizeof(ATAPICommandPacket)==12, E_ERROR ); // check bitfield magic
   ...
   ATAPICommandPacket( E_EXTENDED_OPCODE o, u32 _lba, u32 l )
   {
      ...
      opcode = o;
      lba = _lba;
      type.extended.length = htons32(l);
   }

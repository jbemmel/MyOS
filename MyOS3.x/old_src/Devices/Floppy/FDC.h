...
private:
   ...
   // Registers
   volatile const IOPort8<base+0> statusRegisterA;
   volatile IOPort8<base+1> statusRegisterB;
   volatile IOPort8<base+2> digitalOutputRegister;
   // base+3 TapeDrive register
   volatile const IOPort8<base+4> mainStatusRegister;
   volatile IOPort8_W<base+4> rateSelectRegister;       // write only
   volatile IOPort8<base+5> dataRegister;
   // base+6 reserved
   volatile const IOPort8<base+7> digitalInputRegister;
   volatile IOPort8_W<base+7> configControlRegister;    // write only

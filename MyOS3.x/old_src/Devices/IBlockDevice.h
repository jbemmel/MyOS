...
protected:
    /// @todo blocksize
    inline IBlockDevice(Core::IComponent& c, VERSION v, const char* const uuid, 
            const char* const name, u32 bs=0) :
        IDevice(c, v, uuid, name )
    {
        blocksize=bs;
    }
...
public:
     ...
     */
    virtual myos_result_t readBlocks(u32 lbnStart, u8 count, u8 seriesCount,
            IOCompletionHandler& h) = 0;

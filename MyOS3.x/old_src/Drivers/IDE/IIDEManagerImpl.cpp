...
IIDEManagerImpl::getDevice( u32 id, IIDEDevice*& dev ) const
{
   ...
   switch (id)
   {
   case 0: dev = primary.getMaster(); return true;
   case 1: dev = primary.getSlave(); return true;
   case 2: dev = secondary.getMaster(); return true;
   case 3: dev = secondary.getSlave(); return true;
   default:
       return false;
   }
}

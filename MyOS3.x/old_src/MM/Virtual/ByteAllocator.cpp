...
ByteAllocator::~ByteAllocator() throw()
{
...
void*
ByteAllocator::allocate( size_t BLOCKSIZE ) throw (MM::OutOfMemoryException)
{
   ASSERTIONv( BLOCKSIZE <= this->maxBlockSize(), E_ERROR, BLOCKSIZE );
...
void
ByteAllocator::deallocate( linadr_t block, size_t BLOCKSIZE ) throw()
{

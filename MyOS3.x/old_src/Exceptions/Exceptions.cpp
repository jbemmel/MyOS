...
extern "C" void *__cxa_allocate_exception(size_t thrown_size) throw() SIGNAL_SAFE;
extern "C" void __cxa_free_exception(void *thrown_exception) throw() SIGNAL_SAFE;
extern "C" void __cxa_throw (void *thrown_exception,
             std::type_info *tinfo,
            void (*dest) (void *)) SIGNAL_SAFE
     __attribute__((noreturn));
extern "C" void *__cxa_begin_catch (void *) throw() SIGNAL_SAFE;
extern "C" void __cxa_end_catch () SIGNAL_SAFE;
extern "C" void __cxa_rethrow () __attribute__((noreturn)) SIGNAL_SAFE;
...
// JvB: added
extern "C" void abort() /* throw (MyOS::Exceptions::AbortException) */;
inline void abort() // throw (MyOS::Exceptions::AbortException) 
{ 
   NOT_IN_IRQ;
   DPRINTK( "\nabort() called" );
   // throw MyOS::Exceptions::AbortException();
   while(1);
}
...
*/   
   ...
   ASSERTIONv( Thread::currentThread().canThrow(), E_ERROR, Thread::currentThread().getState() );   
...
extern "C" void
__cxa_throw (void *obj, /*std::type_info*/void *tinfo, void (*ex_destructor) (void *))
{
   DPRINTK( "\n__cxa_throw: obj=%x name=%s", obj, ((std::type_info*)tinfo)->name() );
   ASSERTION( false, E_CRITICAL );
   
   // keep type, via header of 'obj'
   MyOS_ExHeader::getFrom(obj).tinfo = (std::type_info*) tinfo;
   
   // Don't clobber any registers here... 
   SjLj_Function_Context* target = throw_internal(obj,(std::type_info*)tinfo);

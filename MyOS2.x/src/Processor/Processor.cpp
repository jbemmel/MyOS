...
struct CPUID {
   ...
   u8 family      : 4;
   u8 _res1       : 4;
   u8 ext_model   : 4;  // only if family=0xF
   u8 ext_family  : 8;  // only if family=0xF
   u8 _res2       : 4;   
   ...
   u32 ecx_res;
    ...
    union {
        ...
        struct {
           u8 fpu_on_chip     : 1;
           u8 VME_supported   : 1;
           u8 DE_supported    : 1;    // debugging extensions
           u8 PSE_supported   : 1;
           u8 TSC_supported   : 1;
           u8 MSR_supported   : 1;
           u8 PAE_supported   : 1;
           u8 MCE_supported   : 1;    // Machine Check Enable
           u8 CX8_supported   : 1;    // CMPXCHG8B
           u8 APIC_enabled    : 1;    // supported *and* enabled
           u8 __res0__        : 2;
           u8 MTRR_supported  : 1;
           u8 PGE_supported   : 1;
           u8 MCA_supported   : 1;    // Supports MGC_CAP MSR
           u8 CMOV_supported  : 1;
           u8 __res1__        : 7;
           u8 MMX_supported   : 1;
           u8 __res2__        : 8;
...
Processor::E_CPUID_OPCODES 
Processor::getVendorId( char id[13] ) // 12 bytes + '0'
{
   REGS result;

...
public:
   ...
   /// Checks if interrupts are currently enabled (>0) or disabled(0)
	inline static u32 interruptsEnabled()
	{
   ...
   /// Reads the current value of the ESP register
	inline static u32* ESP()
	{
		u32* r; ASMVOLATILE( "movl %%esp, %0" : "=r"(r) ); return r;
	}
   ...
   /**
    * Checks if CPU supports global pages, and enables them
    */
   static bool enableGlobalPages();    

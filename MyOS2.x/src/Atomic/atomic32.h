...
public:
   ...
   inline atomic32( s32 d = 0 );
	...
	inline operator s32() volatile const { return data; }
	// Only use while the value cannot be observed concurrently.
	inline void setNonAtomic( s32 d ) { data = d; }
...
class ATOMIC32 : public atomic32
{
public:
	ATOMIC32( u32 i = 0 ) : atomic32( i ) {}
	
	inline operator T32() volatile const	{ return *((T32*) this); }
...
// For XCHG
struct __xchg_dummy2 { unsigned long a[100]; };
...
inline int atomic32::CmpXchg( u32 cmp, const u32 newval ) volatile
{
	ASMVOLATILE( 
		"cmpxchgl %2, (%3);"
      	"setz %%al"
		:  "=a"(cmp)
		:  "0"(cmp), "r"(newval), "r"(this) 
	);
	return cmp&0xFF;	// == true iff succeeded
}
...
inline s32 atomic32::operator ++() volatile 		       { return ReadAdd(1) + 1; }
inline const s32 atomic32::operator ++(int) volatile   { return ReadAdd(1); }
inline s32 atomic32::operator --() volatile 			    { return ReadAdd(-1) - 1; }
inline const s32 atomic32::operator --(int) volatile   { return ReadAdd(-1); }

inline void atomic32::operator |=(u32 n) volatile { data |= n; }
inline void atomic32::operator &=(u32 n) volatile { data &= n; }

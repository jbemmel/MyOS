   ...
   */
   class IIPEndpoint
   {
	public:
       ...
       */
      virtual myos_result_t send( IPPacket& packet, ipadr_t to, size_t payload, E_IPPROTOCOL p, u32 flags ) = 0;
       ...
       * @return E_MYOS_SUCCESS iff ok
       */
      virtual myos_result_t addARPEntry( ipadr_t forAdr, const buffer& hwAddress, u32 isStatic=false ) = 0;

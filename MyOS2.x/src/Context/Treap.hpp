// Template implementation, included from Treap.h
     ...
     */
         ...
         */
        template <class Comparable>
        bool Treap<Comparable>::insert( const Comparable & x )
        {
         ...
         */
        template <class Comparable>
        Comparable Treap<Comparable>::remove( const Comparable & x )
        {
        ...
        */
        ...
        template <class Comparable>
        const Comparable & Treap<Comparable>::
        findFrom( const Comparable & x, TreapNode<Comparable> *from ) const
        {
        ...
        template <class Comparable>
        inline const Comparable &
        Treap<Comparable>::findFirst( const Comparable & x ) const
        {
        ...
        template <class Comparable>
        inline const Comparable &
        Treap<Comparable>::findNext( const Comparable & x, const Comparable& start ) const
        {
         ...
         */
        template <class Comparable>
        inline bool Treap<Comparable>::isEmpty( ) const
        {
         ...
         */
        template <class Comparable>
        int Treap<Comparable>::foreach( nodefunction f, void* param ) const
        {
            if( !isEmpty( ) )

...
public:
   ...
   /// Creates a special segment descriptor (type,base,limit) at a certain dpl
	inline SegmentDescriptor( E_SEGTYPE t, linadr_t base, u32 limit_in_bytes, EDPL dpl )
	{
    ...
    */
	inline SegmentDescriptor( segatt_t att, linadr_t base, u32 limitInPages, EDPL dpl )
	{
		init( 1, att, (u32) base, limitInPages, dpl );
	}

	inline u32 getBase() const 	{ return ((base31_24 << 24) | (base23_16 << 16) | (base15_0)); }
	inline u32 getLimit() const 	{ return (limit19_16<<16) | (limit15_0); }

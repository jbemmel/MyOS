   ...
   switch (*++n)
	{
      ...
      case ':':   // namespace support, recursive (not time efficient)
      {
		...
		default:
			goto next;	// XX this too many characters in tag names, TODO: restrict
	}
 ...
 */
bool XMLParser::parseAttribute( XMLElement& tag, const char* xml, IXMLHandler& handler, const char* nsprefix )
{
